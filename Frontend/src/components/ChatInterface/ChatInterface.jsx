    ...
    <div className="flex-1 flex flex-col">
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-1/4 border-r border-gray-200 pr-4 overflow-y-auto">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Chat Sessions</h3>
          <Notification message={sessionsError} type="error" onClose={() => setSessionsError(null)} />
          {loadingSessions ? (
        ...
        {/* Right Panel: Chat History and Input */}
        <div className="flex-1 flex flex-col pl-4">
          {selectedFolder ? (
            <>
              <div className="flex-grow overflow-y-auto mb-4 p-4 bg-gray-50 rounded-xl border border-gray-200 shadow-sm">
                <Notification message={chatError} type="error" onClose={() => setChatError(null)} />
                {loadingChat ? (
                  <div className="text-gray-500 text-center py-8">Loading chat history...</div>
